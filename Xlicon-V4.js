                ...
                XeonBotInc.sendMessage(m.chat, {
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: ownername,
                            previewType: "PHOTO",
                            thumbnail: fs.readFileSync('./XliconV4Media/theme/XliconImage.jpg'),
                            sourceUrl: wagc
                        }
                    },
                    text: teks
...
fs.writeFileSync('./src/data/role/user.json', JSON.stringify(xeonverifieduser, null, 2))
        ...
        switch (isCommand) {
            ...
            case 'sim': {
                ...
                await fsx.copy(delb, './XliconV4Media/theme/XliconImage.jpg')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
            ...
            case 'sgm': {
                if (!XeonTheCreator) return XeonStickOwner()
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                await fsx.copy(delb, './XliconV4Media/theme/XliconVideo.mp4')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("923264476886@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
